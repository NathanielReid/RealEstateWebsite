...
// Calls to DB
$properties = $propertyController->showPropertyBySearch($_GET['city'], $_GET['type'], $_GET['structure'], $_GET['price']);
$x = 1;
?>
<!doctype html>
        ...
        <div class="property-section section pt-100 pt-lg-80 pt-md-70 pt-sm-60 pt-xs-50 pb-100 pb-lg-80 pb-md-70 pb-sm-60 pb-xs-50">
            <div class="container">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <!-- Determine if search criteria is met -->
                    <?php if (sizeof($properties) == 0) { ?>
                        <div class="row">
                            <div class="col-xs-6 pr-20">
                                <img class="align-left" src="../assets/images/icons/error1.png" alt="" height="50px" width="50px">
                            </div>
                            <div class="col-xs-6">
                                <h1 class="">No Properties Found</h1>
                            </div>
                        </div>
                    <?php } else { ?>
