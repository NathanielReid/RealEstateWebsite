...
class PropertyController
{
    ...
    // Property Search
    public function showPropertyBySearch($city, $propertyType, $propertyStructure, $propertyPrice) 
    {
        $results = $this->Property->getPropertyBySearch($city, $propertyType, $propertyStructure, $propertyPrice);
        return $results;
    }
}
